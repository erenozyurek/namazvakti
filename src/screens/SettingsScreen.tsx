...
export const SettingsScreen: React.FC = () => {
  ...
  const [selectedEzan, setSelectedEzan] = useState<string>('Ezan 1');
  ...
  const ezanOptions = ['Ezan 1', 'Ezan 2', 'Ezan 3'];
          ...
          <View style={styles.settingCard}>
            ...
            >
              <View style={styles.settingLeft}>
                ...
                <View style={styles.settingTextContainer}>
                  ...
                  <Text style={styles.settingDescription}>
                    Ezan okuyucusu seçin
                  </Text>
                </View>
              </View>
              <View style={styles.pickerValue}>
                <Text style={styles.pickerValueText}>{selectedEzan}</Text>
                <Ionicons 
            ...
            {showEzanPicker && (
              <View style={styles.pickerContainer}>
                {ezanOptions.map((option) => (
                  <TouchableOpacity
                    key={option}
                    style={[
                      styles.pickerOption,
                      selectedEzan === option && styles.pickerOptionSelected
                    ]}
                    onPress={() => {
                      setSelectedEzan(option);
                      setShowEzanPicker(false);
                    }}
                  >
                    <Text style={[
                      styles.pickerOptionText,
                      selectedEzan === option && styles.pickerOptionTextSelected
                    ]}>
                      {option}
                    </Text>
                    {selectedEzan === option && (
